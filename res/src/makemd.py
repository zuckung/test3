...
def wentry(filex):
	...
	if os.path.exists(pathtoplugins + entry + "/icon.png") == True:
		...
		w, h = im.size
		if h > w:
			filex.writelines("<img src="+ pathtoplugins + entry + "/icon.png height=55></img>\n")
		else:
			filex.writelines("<img src="+ pathtoplugins + entry + "/icon.png width=55></img>\n")
